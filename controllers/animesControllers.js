const animes = [
    {
      ...
      description: 'lorem ipsum asdasdasdasdasdasdasdasddsaasdsadasd'
    },
    {
      id: 2,
      name: "black_clover",
    ...
    },
    {
      id: 4,
      name: "jujutsu_kaisen",
      img: "https://m.media-amazon.com/images/M/MV5BNzQyYzU3Y2MtOWY2Yy00ZGM2LTg3ZTUtMDJkZTJiMmEzMjYxXkEyXkFqcGdeQXVyMTI2NTY3NDg5._V1_.jpg"
    },
    {
      id: 5,
    ...
    },
    {
      id: 8,
      name: "itachi_uchiha",
      img: "https://comicvine.gamespot.com/a/uploads/scale_small/0/378/859934-god2vj0xj3.jpg"
    },
    {
      id: 9,
      name: "one_piece",
...
const animesControllers = {
    obtenerTodosLosAnimes:(req,res)=>{
        res.json({respuesta:animes})
    },
    obtenerUnAnime:(req,res)=>{
        const id = req.params.id        
        const anime = animes.find(anime => anime.id.toString() === id)
        
        res.json({respuesta:anime})
    },
    cargarUnAnime:(req,res)=>{
